...
def function1():
    ...
    os.system("\"C:/Program Files/Python3/python.exe\" dataset_capture.py")
    
def function2():
    
    os.system("\"C:/Program Files/Python3/python.exe\" training_dataset.py")

def function3():

    os.system("\"C:/Program Files/Python3/python.exe\" recognizer.py")
    playsound('sound.mp3')
